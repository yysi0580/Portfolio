...
- 대표 프로젝트인 `Barotruck`와 `ADHD Todo`를 중심으로 주문·배차·정산 흐름, 사용자 실행 보조 흐름, 인증, API 설계, 운영 리스크 관리 경험이 빠르게 읽히도록 구성했습니다.
...
- `Capability`: 상태 로직, 인증/권한, 운영 기능, 협업 역량 정리
...
- `ADHD Todo` 프로젝트에는 프론트 시연 주소, FastAPI Swagger 문서 주소, 백엔드 GitHub 저장소 링크를 연결했습니다.
